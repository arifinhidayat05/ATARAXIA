...
class ProdukController extends Controller
{
    ...
    {
        // Menambahkan validasi dengan pesan kesalahan kustom
        ...
        // Menambahkan data pengguna dan status
